...
from winAuto.utils.rotypes.Windows.Foundation import IReference, Rect, IAsyncOperation
from winAuto.utils.rotypes.Windows.Foundation.Collections import IVectorView
from winAuto.utils.rotypes.Windows.Globalization import Language
from winAuto.utils.rotypes.Windows.Graphics.Imaging import SoftwareBitmap
from winAuto.utils.rotypes.inspectable import IInspectable
from winAuto.utils.rotypes.idldsl import define_winrt_com_method, _static_propget, _static_method, _non_activatable_init, runtimeclass, GUID
from winAuto.utils.rotypes.winstring import HSTRING
